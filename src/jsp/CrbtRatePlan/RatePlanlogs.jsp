...
-->
																...
																%>
																								...
																								{
																																%>
																																								<a href="rateplan_manage.jsp?pid=<%=pageId-1%>&keywords=<%=keywords%>&srchtext=<%=searchtext%>&searchId=0">&lt;&lt; <%=TSSJavaUtil.instance().getKeyValue("previous")%></a> &nbsp;&nbsp;
																																<%
																								}
																								else
																								{
																																...
																																%>
																																								...
																																								{
																																																%>
																																																								&nbsp;&nbsp;<a href="rateplan_manage.jsp?pid=<%=pageId+1%>&keywords=<%=keywords%>&srchtext=<%=searchtext%>&searchId=0"><%=TSSJavaUtil.instance().getKeyValue("next")%> &gt;&gt;</a>
																																																								<%
																																								}
																																								else
																																								{
