...
<%
 Logger logger = Logger.getLogger ("viewlogs.jsp");
																...
																function checkedA()
                {
                        ...
                        if((document.forms.form.keyword[1].value==2) && document.forms.form.keyword[1].checked)
                        {
                                document.forms.form.keyword[1].checked=false;
																...
																if(pageId == 0)
																{
																								i = weblogs.getLog (logscode,keywords,start_date,end_date,pageId);
																								...
																								else if( logscode.size() > 0)
																								{
																																...
																																for(int r=start; r<=end; r++)
																																{
																																								%>
																																																...
																																																<td align="left"><%= ((WebAdminLog)chargecodeArr[r-1]).getlink() %> </td>
