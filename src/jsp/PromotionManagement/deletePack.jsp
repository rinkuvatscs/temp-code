...
<%
    Logger logger = Logger.getLogger ("deletePack.jsp");
	SessionHistory sessionHistory = (SessionHistory) session.getAttribute("sessionHistory");
	if(sessionHistory == null ||  !sessionHistory.isAllowed(2013) )
	{
         %>
	...
	int i = promoManager.deletePromoPack(promoArr);
	...
	{
	  logger.info("webadmin/PromotionPack: No Promotional pack selected");
                %>
                 <script language="JavaScript">
                        alert("<%=TSSJavaUtil.instance().getKeyValue("trylater",defLangId)%>")
                        window.location="home.jsp"
