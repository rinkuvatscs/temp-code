...
<%
   Logger logger = Logger.getLogger ("rateplan_add.jsp");
SessionHistory sessionHistory = (SessionHistory) session.getAttribute("sessionHistory");
				logger.info("----------cdddddddddddddddddddddddddddddddddddddddddddddddddddddd"+sessionHistory.isAllowed(2071)+"        "+sessionHistory);
		if (sessionHistory == null || !sessionHistory.isAllowed(2071)) 
		{
        session.invalidate();
%>
...
<%
    ...
    {   
        ...
        //ArrayList packageAl = new ArrayList();
				...
				logger.debug("----------cdddddddddddddddddddddddddddddddddddddddddddddddddddddd");
